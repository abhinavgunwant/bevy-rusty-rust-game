use bevy::{
    app::AppExit, input::{ keyboard::{ Key, KeyboardInput },
    mouse::{MouseScrollUnit, MouseWheel}, ButtonState }, prelude::*,
};

use crate::{
    game::item::events::SpawnItemEvent,
    ui::dev::console::{
        components::{ConsoleHistory, ConsoleTextLine},
        events::ConsoleCommandEvent,
    },
    lang::interpret::interpret,
};
